<ul class="nav flex-column">
    ...
    @foreach (unserialize($setting->users_allow_create_disposition) as $user)
        @if ($user === Auth::user()->department_id)
          <li class="nav-item"></li><a href="#" class="nav-link"><i class="fa fa-envelope-open fa-lg"></i>&nbsp;Buat Surat</a>
        @endif
    @endforeach
    <li><hr></li>
    <span class="sidebar-heading text-muted px-3">Surat Masuk</span>
    <li class="nav-item"><a href="#" class="nav-link"><i class="fa fa-inbox fa-lg"></i>&nbsp;Disposisi Masuk</a></li>
    <li class="nav-item"><a href="#" class="nav-link"><i class="fa fa-boxes fa-lg"></i>&nbsp;Disposisi Keluar</a></li>
    <li><hr></li>
